...
const ServicePage = ({ params }: ServicePageProps) => {
  ...
  // Memoize service content
  const serviceContent = useMemo(() => 
    servicesContent[slug as keyof typeof servicesContent] as ServiceContent || {
  ...
  const images = useMemo(() => ({
    hero: serviceContent.heroImage || defaultImages.hero,
    heroBackgroundImage: serviceContent.heroBackgroundImage || defaultImages.heroBackgroundImage,
    overview: serviceContent.overviewImage || defaultImages.overview,
    pattern: serviceContent.backgroundPattern || defaultImages.pattern,
    features: serviceContent.featureImages || defaultImages.features
  }), [serviceContent]);
              ...
              {serviceContent.features.map((feature, index) => (
                ...
                >
                  <Box sx={{ 
                    ...
                    >
                      {serviceContent.featureDescriptions?.[index] || 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.'}
                    </Typography>
                  </Box>
                </Paper>
              ))}
